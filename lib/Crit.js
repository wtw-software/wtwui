...
define([
  ...
  Crit = (function(){
    ...
    Crit.prototype.render = function() {
    ...
    Crit.prototype.takeDamage = function(damage) {
      var self = this,
          damage = Crit.getRandomNumber(this.options.mindamage, this.options.maxdamage),
      ...
      this.health -= damage
      var health = (this.health / (this.options.life / 100)) || 0
      if(health < 0) {
        health = 0
    ...
    Crit.prototype.killed = function(callback) {
      this.on('killed', callback)
    }
